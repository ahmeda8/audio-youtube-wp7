...
namespace MusicMeTube
{
    public partial class App : Application
    {
        ...
        {
            //ErrorLogging.Log(e.Exception.Message);
            ErrorLogging.Log(this.GetType().ToString(),e.Exception.Message,"AppCrashNavigationError",string.Empty);
            if (System.Diagnostics.Debugger.IsAttached)
            {
        ...
        {
            //ErrorLogging.Log(e.ExceptionObject.Message);
            ErrorLogging.Log(this.GetType().ToString(), e.ExceptionObject.Message, "AppCrashUnhandledException", string.Empty);
            if (System.Diagnostics.Debugger.IsAttached)
            {
